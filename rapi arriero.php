...
$sql = $con->prepare("SELECT id, nombre, precio FROM rapi_arriero WHERE activo=1");
$sql->execute();
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Rapi Arrieros</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <?php
                                $id = $row['id'];
                                $imagen = "images/platos/rapi arrieros/" . $id . "/rapi.png";
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="./descripcion/rapi arriero.php?id=<?php echo $row['id']; ?>&token=<?php echo 
