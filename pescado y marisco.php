...
$sql = $con->prepare("SELECT id, nombre, precio FROM pescado_marisco WHERE activo=1");
$sql->execute();
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pescados y Mariscos</a>
                        ...
                        <a href="base de datos/formulario.php" class="nav-item nav-link">Regustrase</a>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <?php
                                $id = $row['id'];
                                $imagen = "images/platos/pescados y mariscos/" . $id . "/pescado.png";
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a href="./descripcion/pescado y marisco.php?id=<?php echo $row['id']; ?>&token=<?php echo 
